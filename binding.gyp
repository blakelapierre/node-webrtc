        ...
        'conditions': [
          ['OS=="linux"', {
            'libraries': [
              ...
              '../<(libwebrtc_out)/webrtc/base/libwebrtc_base.a',
              ...
              '../<(libwebrtc_out)/chromium/src/third_party/libsrtp/libsrtp.a',
              '../<(libwebrtc_out)/chromium/src/third_party/opus/libopus.a',
              '../<(libwebrtc_out)/chromium/src/third_party/protobuf/libprotobuf_lite.a',
              '../<(libwebrtc_out)/chromium/src/third_party/usrsctp/libusrsctplib.a',
              '-Wl,--start-group',
              '../<(libwebrtc_out)/chromium/src/third_party/libvpx/libvpx.a',
              '../<(libwebrtc_out)/chromium/src/third_party/libvpx/libvpx_asm_offsets_vp8.a',
              '../<(libwebrtc_out)/chromium/src/third_party/libvpx/libvpx_intrinsics_mmx.a',
              '../<(libwebrtc_out)/chromium/src/third_party/libvpx/libvpx_intrinsics_sse2.a',
              '../<(libwebrtc_out)/chromium/src/third_party/libvpx/libvpx_intrinsics_ssse3.a',
              '../<(libwebrtc_out)/chromium/src/third_party/libvpx/libvpx_intrinsics_sse4_1.a',
              '-Wl,--end-group',
